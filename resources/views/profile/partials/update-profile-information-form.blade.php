    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="gender" name="gender"
                ...
                <option value="M" {{ old('gender', $user->gender) === 'M' ? 'selected' : '' }}>{{ __('Male') }}
                </option>
                <option value="F" {{ old('gender', $user->gender) === 'F' ? 'selected' : '' }}>{{ __('Female') }}
                </option>
            </select>
        ...
        <div>
            ...
            <x-text-input id="dob" name="dob" type="date" class="mt-1 block w-full" :value="old('dob', optional($user->dob)->format('Y-m-d'))"
